...
export const MESSAGES: mess[] = [
    {
        ...
        content: {
            ...
            topics: [
                {
                    sub_heading: "1) Our goal is to elucidate the effect of DJ-1 mutations in the PD-progression using neuronal cells and genetic manipulation using S cerevisiae as a model system.",
                    content: [
                ...
                {
                    sub_heading: "2) Role of Heat Shock Proteins in Health and Diseases:",
                    content: [
                ...
                {
                    sub_heading: "3) Understanding Maintenance of mitochondrial quality control: Implications in human health.",
                    content: [
                ...
                {
                    sub_heading: "4) Elucidating the organization of pre-sequence translocase and mechanisms of protein translocation across the mitochondria.",
                    content: [
            ...
            contact: "http://pdslab.biochem.iisc.ernet.in/  (Google Search word: Molecular chaperone labs/Mitochondria Biology Lab)    Twitter:  Mitochondrial Biology Lab  @pdslab_iisc",
            focus: "Likely Research Topic(s):",
            focus_detail: "a)	Understanding the role of DJ-1/Park7 paralogs in the maintenance of redox homeostasis and organellar health: Implications in Parkinson's disease progression ",
        },
