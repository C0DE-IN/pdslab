...
export const PI: Pi = {
    title: "Dr. ",
    name: "Patrick D' Silva",
    imgSrc: "/images/people/patrick.jpg",
    position: "Professor",
    email: "patrick@iisc.ac.in",
    credentials: ["Ph.D: Indian Institute of Technology, Powai-Bombay", "PDF: University of Wisconsin-Madison, USA"],
    started: "2007",
    summary: [
        {
            list: {
